  ...
  function runDialogue(dialogue) {
    ...
    function insertNext() {
      ...
      if (dialogue[currLine].prompt) {
        $promptDialogue
        .append(
          '<div  tabindex="1" class="talk-bubble tri-right border round btm-left-in"><p>' +  dialogue[currLine].prompt + '</p></div>')
        .delay(delayTime)
        .children()
        .fadeIn().promise().done(function () {
          ...
          dialogue[currLine].answers.forEach(function(answer) {
            $answersDialogue
            .append('<div tabindex="2" class="dialogue-option talk-bubble tri-right border round btm-right-in ' + colorSchemes.splice(Math.random() * colorSchemes.length, 1) + '" data-next_label=' + answer.next + '><p>' + answer.m + '</p><div tabindex="3" class="yoac-choose"> < </div></div>')
          })
